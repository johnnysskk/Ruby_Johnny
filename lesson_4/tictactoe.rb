...
def computer_place_item(board)
  ...
  winning_lines.each do |line| 
    computer_place = find_risk(line,board)
    break if computer_place
  end

  if !computer_place
    board[empty_place(board).keys.sample] = COMPUTER_MARKER
  else
    board[computer_place] = COMPUTER_MARKER
  end
end
...
>>>>>>> 65160e5f72350a0bb3aa6e7efe3d8d5a62494a86
